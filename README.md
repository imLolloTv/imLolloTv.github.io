# 🖥️ imLolloTv.github.io

Personal static website published via **GitHub Pages**, built with **HTML, CSS, and JavaScript**.
...
This repository contains all the files necessary for the operation of the website associated with the **imLolloTv** account.  
...
Discord information is retrieved through the **APIs of [Lanyard](https://github.com/Phineas/lanyard)**, a free service that provides real-time Discord presence data.
